...
public class plainte2 extends AppCompatActivity {
        ...
        suspend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(suspendtxt.isEmpty()){
                    Toast.makeText(plainte2.this, "Enter the number of suspension months", Toast.LENGTH_SHORT).show();
                }
                else{
                    databaseReference.child("Plaintes").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            final String cook=snapshot.child("plainte2").child("cook").getValue(String.class);
                            System.out.println(cook);
                            System.out.println(suspendtxt);
                            databaseReference.child("Users").child(cook).child("monthsofsuspension").setValue(suspendtxt);
                            databaseReference.child("Plaintes").child("plainte2").child("description").setValue("already processed");
                            Toast.makeText(plainte2.this, "cook:"+cook+"suspended", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(getApplicationContext(), plainte3.class);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseReference.child("Plaintes").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        databaseReference.child("Plaintes").child("plainte2").child("description").setValue("already processed");
                        Toast.makeText(plainte2.this, "Plainte rejected", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(), plainte3.class);
                        startActivityForResult(intent, 0);
                    }
